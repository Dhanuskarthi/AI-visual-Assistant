        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h4 className="font-bold text-white text-xs md:text-sm flex items-center gap-2">
              ...
              <span className="text-[10px] bg-amber-500/30 text-amber-300 border border-amber-500/40 px-2.5 py-0.5 rounded-full font-semibold">
                Clear English Voice
              </span>
              {isPlaying && (
        ...
        <div className="flex items-center gap-2 self-start md:self-auto">
          ...
          >
            {isPlaying ? (
              ...
              <>
                <Volume2 className="w-3.5 h-3.5" /> Read Aloud All Steps
              </>
            )}
          </button>
