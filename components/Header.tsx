    ...
    <header className="sticky top-0 z-50 backdrop-blur-xl bg-slate-950/80 border-b border-slate-800/80 transition-all shadow-2xl">
      <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-3 group">
          <div className="relative p-2.5 rounded-2xl bg-gradient-to-br from-rose-500 via-amber-500 to-rose-600 text-white shadow-lg shadow-rose-950/50 group-hover:scale-105 transition-all duration-300">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className="font-extrabold text-white text-base md:text-lg tracking-tight group-hover:text-rose-400 transition-colors">
                FixVision <span className="text-transparent bg-clip-text bg-gradient-to-r from-rose-400 via-amber-300 to-emerald-400">AI</span>
              </h1>
              <span className="hidden sm:inline-flex items-center gap-1 text-[10px] font-mono font-bold uppercase tracking-wider bg-rose-500/10 text-rose-300 px-2 py-0.5 rounded-md border border-rose-500/20">
                <Activity className="w-2.5 h-2.5 text-emerald-400 animate-pulse" /> 3.0 Multimodal
              </span>
            </div>
          ...
          <nav className="flex items-center gap-1.5 bg-slate-900/90 p-1 rounded-2xl border border-slate-800">
            <Link
              ...
              className={`px-3.5 py-1.5 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 ${
                pathname === "/"
                  ? "bg-gradient-to-r from-rose-600 to-rose-700 text-white shadow-md shadow-rose-950/60"
